...
$set['category'] = 'cdr';
$set['name'] = _('Cancel disposition enabled');
$set['description'] = _('The "canceldispositionenabled" option in Asterisk configures Call Detail Records (CDR) to distinguish calls that were cancelled (abandoned by the caller before being answered) from other unanswered calls. When this option is enabled, calls ending due to the caller hanging up during ringing will have the disposition "CANCEL" instead of the default "NO ANSWER". This option is supported on Asterisk version 20 and above.');
$set['value'] = 0;
$set['defaultval'] =& $set['value'];
$set['hidden'] = 0;
$set['emptyok'] = 0;
...
$set['module'] = 'cdr';
$set['type'] = CONF_TYPE_BOOL;
$freepbx_conf->define_conf_setting('CANCELDISPOSITION',$set);
