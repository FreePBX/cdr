<div class="col-md-12">
    ...
    <thead>
            <tr class="cdr-header">
            <th data-field="timestamp" data-sortable="true" data-formatter="Cdr.formatDate"><?php echo _("Date")?></th>
            <th data-field="text" data-sortable="true" data-formatter="Cdr.formatDescription"><?php echo _("Description")?></th>
						<th data-field="duration" data-sortable="true" data-formatter="Cdr.formatDuration"><?php echo _("Duration")?></th>
						<?php if($showPlayback) { ?>
							<th data-field="playback" data-formatter="Cdr.formatPlayback"><?php echo _("Playback")?></th>
						<?php } ?>
						<th data-field="controls" data-formatter="Cdr.formatActions"><?php echo _("Controls")?></th>
        </tr>
    </thead>
</table>
</div>
